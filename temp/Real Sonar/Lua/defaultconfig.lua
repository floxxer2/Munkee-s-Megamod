...
config.SonarTerminals["sonarmonitor"]["sounds"] = "beacon"
...
config.WearableProtections["slipsuit"] = {}
config.WearableProtections["slipsuit"]["damageMultiplier"] = 0.05
config.WearableProtections["slipsuit"]["anechoic"] = false
