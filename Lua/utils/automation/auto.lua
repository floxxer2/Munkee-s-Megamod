...
function NTI.InfectCharacterRandom(character, limb)
    ...
    local inf = inflst[math.random(#inflst)]
    local randomval = math.random(10)
    HF.SetAfflictionLimb(character, inf, limb, randomval)
  ...
  ["NT Infections/Lua/Scripts/humanupdate.lua"] = {
    ...
    NT.LimbAfflictions.infectionlevel={update=function(c,limbaff,i,type)
        ...
        -- Remove infection if the limb is cyber
        if HF.GetAfflictionStrengthLimb(c.character, type, "ntc_cyberlimb") > 0 then
...
Auto.ModTable = {
  ...
  [3294574390] = { name = "NT Eyes", version = "2.1.0h1" },
  [3286567141] = { name = "NT Infections", version = "1.0.2" },
  ...
  [3033618197] = { name = "Pure Empty Level", version = "1.4" },
  ...
  [2962899782] = { name = "Rift Engine", version = "1.0.31" },
