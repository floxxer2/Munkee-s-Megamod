...
function rsm.EndRoundTimer(timer, inputStr)
    ...
    local hull = Megamod.EscapePortal.SpawnPortal()
    local str = " The round is ending in " .. getTimeToEnd(timer) .. " Escape portal opened in \"" .. tostring(hull.RoomName) .. "\", get out of there!"
    if inputStr then
