...
Hook.Add("sonarPing", "sonarPing", function(effect, deltaTime, item, targets, worldPosition)
    ...
    elseif soundPreset == "beacon" then
        airSounds = RealSonar.airSoundsBeacon
        waterSounds = RealSonar.waterSoundsBeacon
        suitSounds = RealSonar.suitSoundsBeacon
    end
...
Hook.Add("sonarPingDirectional", "sonarPingDirectional", function(effect, deltaTime, item, targets, worldPosition)
    ...
    if soundPreset == "shuttle" then
        ...
        suitSounds = RealSonar.suitSoundsShuttle
    elseif soundPreset == "beacon" then
        airSoundsDirectional = RealSonar.airSoundsBeaconDirectional
        waterSoundsDirectional = RealSonar.waterSoundsBeaconDirectional
        suitSoundsDirectional = RealSonar.suitSoundsBeaconDirectional
        waterSounds = RealSonar.waterSoundsBeacon
        suitSounds = RealSonar.suitSoundsBeacon
    end
