...
for package in ContentPackageManager.EnabledPackages.All do
    ...
    if tostring(package.UgcId) == "2938034581" then
        RealSonar.LITE = true
    -- Undersea Horrors or Barotraumatic Creature Pack, or Barotraumatic.
    elseif tostring(package.UgcId) == "2667451351" or tostring(package.UgcId) == "2831987252" or tostring(package.UgcId) == "2518816103" then
