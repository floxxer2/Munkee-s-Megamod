...
-- Beacon sounds
function RealSonar.airSoundsBeacon(character, strength)
    if strength > 95 then
        RealSonar.GiveAffliction(character, "sonarPingAirCloseBeacon", 1)
    elseif strength > 50 then
        RealSonar.GiveAffliction(character, "sonarPingAirMediumBeacon", 1)
    else
        RealSonar.GiveAffliction(character, "sonarPingAirFarBeacon", 1)
    end
end
function RealSonar.airSoundsBeaconDirectional(character, strength)
    if strength > 95 then
        RealSonar.GiveAffliction(character, "sonarPingAirCloseBeaconDirectional", 1)
    elseif strength > 50 then
        RealSonar.GiveAffliction(character, "sonarPingAirMediumBeaconDirectional", 1)
    else
        RealSonar.GiveAffliction(character, "sonarPingAirFarBeaconDirectional", 1)
    end
end

function RealSonar.waterSoundsBeacon(character, strength)
    if strength > 75 then
        RealSonar.GiveAffliction(character, "sonarPingWaterVeryCloseBeacon", 1)
    elseif strength > 50 then
        RealSonar.GiveAffliction(character, "sonarPingWaterCloseBeacon", 1)
    elseif strength > 25 then
        RealSonar.GiveAffliction(character, "sonarPingWaterMediumBeacon", 1)
    else
        RealSonar.GiveAffliction(character, "SonarPingWaterFarBeacon", 1)
    end
end
function RealSonar.waterSoundsBeaconDirectional(character, strength)
    if strength > 75 then
        RealSonar.GiveAffliction(character, "sonarPingWaterVeryCloseBeaconDirectional", 1)
    elseif strength > 50 then
        RealSonar.GiveAffliction(character, "sonarPingWaterCloseBeaconDirectional", 1)
    elseif strength > 25 then
        RealSonar.GiveAffliction(character, "sonarPingWaterMediumBeaconDirectional", 1)
    else
        RealSonar.GiveAffliction(character, "SonarPingWaterFarBeaconDirectional", 1)
    end
end

function RealSonar.suitSoundsBeacon(character, strength)
    if strength > 75 then
        RealSonar.GiveAffliction(character, "sonarPingSuitVeryCloseBeacon", 1)
    elseif strength > 50 then
        RealSonar.GiveAffliction(character, "sonarPingSuitCloseBeacon", 1)
    elseif strength > 25 then
        RealSonar.GiveAffliction(character, "sonarPingSuitMediumBeacon", 1)
    else
        RealSonar.GiveAffliction(character, "SonarPingSuitFarBeacon", 1)
    end
end
function RealSonar.suitSoundsBeaconDirectional(character, strength)
    if strength > 75 then
        RealSonar.GiveAffliction(character, "sonarPingSuitVeryCloseBeaconDirectional", 1)
    elseif strength > 50 then
        RealSonar.GiveAffliction(character, "sonarPingSuitCloseBeaconDirectional", 1)
    elseif strength > 25 then
        RealSonar.GiveAffliction(character, "sonarPingSuitMediumBeaconDirectional", 1)
    else
        RealSonar.GiveAffliction(character, "SonarPingSuitFarBeaconDirectional", 1)
    end
end
