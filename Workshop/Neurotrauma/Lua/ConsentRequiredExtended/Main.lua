...
local Api = require("workshop.Neurotrauma.Lua.ConsentRequiredExtended.Api")
local OnItemApplied = require("workshop.Neurotrauma.Lua.ConsentRequiredExtended.OnItemApplied")
local onMeleeWeaponHandleImpact = require("workshop.Neurotrauma.Lua.ConsentRequiredExtended.onMeleeWeaponHandleImpact")
local Config = require("workshop.Neurotrauma.Lua.ConsentRequiredExtended.Config")
